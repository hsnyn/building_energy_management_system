...
# Form implementation generated from reading ui file 'first_floor.ui'
#
...
class Ui_Dialog(QtWidgets.QWidget):
    def setupUi(self, Dialog):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("1F.jpg"))
        ...
        self.label_4.setGeometry(QtCore.QRect(520, 180, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
        ...
        self.label_5.setGeometry(QtCore.QRect(530, 730, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
        ...
        self.label_6.setGeometry(QtCore.QRect(880, 550, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 390, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "1st Floor Temperature"))
