...
# Form implementation generated from reading ui file 'third_floor.ui'
#
...
class Ui_Dialog(QtWidgets.QWidget):
    def setupUi(self, Dialog):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("3F.jpg"))
        ...
        self.label_4.setGeometry(QtCore.QRect(960, 310, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
        ...
        self.label_5.setGeometry(QtCore.QRect(590, 260, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
        ...
        self.label_6.setGeometry(QtCore.QRect(330, 790, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
        ...
        self.label_7.setGeometry(QtCore.QRect(80, 230, 121, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(28)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "3rd Floor Temperature"))
